...
public class BibExporter {
   ...
   * Hint: You may need to utilize the method `toString` of the class `Paper` You
   * may need to remove the `return null` in the skeleton.
   */
  ...
  /**
   * Export the content of the paper to a bib file, of which the full name is
   * bibFile. If any exception throws, please set the field `isErr` to true.
   * Otherwise, `isErr` is false. Hint: You may need to utilize the method
   * `generate` to get the tokenized string of the field `papers`.
   */
  public void export() {
    // TODO: complete the definition of the method `export`
