...
public class BibParser {
  ...
  /**
   * Extract the papers from the content of a bib file. * If any exception throws,
   * please set the field `isErr` to true. Otherwise, `isErr` is false.
   *
   ...
   *                          Science ...}, pages = {128-141}, title = {Efficient
   *                          chaotic iteration strategies with widenings}, volume
   *                          = {735 LNCS}, year = {1993}, } The key of the paper
   *                          should be Bourdoncle1993.
   *
   *                          Hint: The function might be quite verbose if you
   *                          just define this method to achieve the
   *                          functionality. You can try to define several helper
   *                          methods to process different kinds of lines in the
   *                          bib file, and then invoke them in this method.
   */
  public void parse() {
    ...
    String[] searchKeyWordArray = { "doi = {", "author = {", "title = {", "journal = {", "keywords = {", "year = {",
        "url = {", "abstract = {" };
    try {
