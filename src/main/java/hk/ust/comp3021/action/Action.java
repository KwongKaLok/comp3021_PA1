...
public class Action {
  ...
  enum ActionType {
    ADD_COMMENT, ADD_LABEL, DOWNLOAD_PAPER, UPLOAD_PAPER, SEARCH_PAPER
  };

  private String id;

  /**
   * Hint: When you need to initialize the field or set the value of the field you
   * can just use `new Date()` to set the time to be the current time stamp.
   */
  private Date time;
